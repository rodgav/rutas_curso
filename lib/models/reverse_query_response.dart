...
//
//     final reverseQueyResponse = reverseQueyResponseFromJson(jsonString);

import 'dart:convert';

ReverseQueyResponse reverseQueyResponseFromJson(String str) =>
    ReverseQueyResponse.fromJson(json.decode(str));

String reverseQueyResponseToJson(ReverseQueyResponse data) =>
    json.encode(data.toJson());

class ReverseQueyResponse {
  ReverseQueyResponse({
    this.type,
    this.query,
    this.features,
  ...
  factory ReverseQueyResponse.fromJson(Map<String, dynamic> json) =>
      ReverseQueyResponse(
        type: json["type"],
